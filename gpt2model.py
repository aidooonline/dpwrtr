...
def generate_prompt(main_keyword,instruction,content_keywords,related_keywords):
    ...
    prompt = ''
    if instruction == '1':
        prompt += f'Write a comprehensive article not less than 1000 words using "{main_keyword}" as the title and the following keywords as content ideas for the article. Create subtopics from the keywords and Dont repeat main title keyword more than 3 times:\n\n'
