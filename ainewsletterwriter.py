...
def generate_prompt(main_keyword,instruction,content_keywords,related_keywords):
    ...
    if instruction == '1':
        ...
        prompt += f'Acting as a news writer, use the following data, write all the news stories from the provided data. with each title according to the data. Dont repeat stories, gather enough ideas and compose each news story with following format: <content><h3>News Title 1</h3><img src="https://websitesgh.com/generateimage?imagename=imagekeyword" class="newsimage" /> <p>News Story 1</p></content>  <content><h3>News Title 2</h3><img src="https://websitesgh.com/generateimage?imagename=imagekeyword" class="newsimage" /> <p>News Story 2</p></content>. Where imagename keyword variable should be a two letter keywords you should generate from the subject matter of every story. Mostly nouns are preferred or main characters name in the story is preferred for the imagename variable keywords. NOTE: Very important. Dont plagiarize from the data, rewrite in your own words and create your own titles based on the stories. And also be factual from the data, dont halucinate unless you have backing information. Write as many news story containing in the following data:\n\n{content_keywords}\n'
